...
function scene:createScene( event )
	...
	score1:setReferencePoint(display.CenterLeftReferencePoint); score1:setTextColor(0)
	score1.x = (_W*0.5)+10; score1.y = _H*0.485 

	local score2 = display.newText(screenGroup, highScore, 0,0, native.systemFontBold, 18)
	score2:setReferencePoint(display.CenterLeftReferencePoint); score2:setTextColor(0)
	score2.x = (_W*0.5)+10; score2.y = _H*0.576 
end
